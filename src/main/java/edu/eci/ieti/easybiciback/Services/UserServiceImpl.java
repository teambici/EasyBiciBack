...
public class UserServiceImpl implements UserServices {
    ...
    public Usuario createUser(Usuario user) {
        return usuarioRepo.save(new Usuario(user.getNombre(), user.getCorreo(), user.getTarjeta(),user.getPuntuacion(),user.getUbicacion(),user.getDocumento(), user.getContrasena()));
    }
